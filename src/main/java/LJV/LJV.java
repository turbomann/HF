package LJV;//- LJV.java --- Generate a graph of an object, using Graphviz
...
import static com.sun.org.apache.xalan.internal.xsltc.compiler.sym.DOT;
...
public class LJV {
    ...
    /**
     ...
     directory.
     */
    private final static String DOT_COMMAND = "C:\\Program Files (x86)\\Graphviz2.38\\bin\\dot.exe";
